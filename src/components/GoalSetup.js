   ...
   handleSubmit(evt){
       ...
       .then(response => {
           ...
           if (parsed.unrealistic){
               this.setState({unrealistic: true, dailySaveGoal: parsed.dailySaveGoal})
           } else {
           ...
           <p>
               {
                   ...
                   <p>A daily savings goal of ${this.state.dailySaveGoal} might not be realistic. Modify your goals, or click <button onClick={this.renderFixedInput}>here</button> to continue </p>:
                   null
               }
           </p>
       </div>
